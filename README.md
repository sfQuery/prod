...
- [ sfQuery: jQuery plugin for Salesforce.com](#-sfquery-jquery-plugin-for-salesforcecom)
	...
	- [Working with Metadata](#working-with-metadata)
		- [getMetaData and getObjectDescribe examples](#getmetadata-and-getobjectdescribe-examples)
		- [getMetaData and getObjectDescribe options](#getmetadata-and-getobjectdescribe-options)
		- [getObjectDetail examples](#getobjectdetail-examples)
		- [getObjectDetail options](#getobjectdetail-options)
